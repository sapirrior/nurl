#ifndef NUT_ENGINE_REQUEST_H
#define NUT_ENGINE_REQUEST_H

#include "nut.h"
#include "engine/utils/nut_headers.h"
...
typedef void (*nut_req_headers_cb)(NutRequest *req, const nut_http_response_t *res, void *user_data);
...
void         nut_request_from_args(NutRequest *req, const char *method,
