#ifndef NUT_DECOMPRESS_H
#define NUT_DECOMPRESS_H
 ...
 */
unsigned char *nut_decompress_gzip_deflate(const unsigned char *src, size_t src_len, size_t *out_len);

#endif /* NUT_DECOMPRESS_H */
